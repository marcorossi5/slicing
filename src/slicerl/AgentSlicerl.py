...
from slicerl.Slicer import DiscreteSlicer, ContinuousSlicer
from rl.agents.dqn import DQNAgent
from rl.agents.ddpg import DDPGAgent
from tensorflow.keras.models import model_from_json

#======================================================================
class DQNAgentSlicerl(DQNAgent):
    """DQN Agent for slicing"""

    #----------------------------------------------------------------------
    def __init__(self, *args, **kwargs):
        """Initialize the DQN agent."""
        super(DQNAgentSlicerl, self).__init__(*args, **kwargs)
    ...
    def slicer(self):
        ...
        return DiscreteSlicer(self.model, self.test_policy)

#======================================================================
class DDPGAgentSlicerl(DDPGAgent):
    """DDPG Agent for slicing"""
